...
# Load configuration from environment variables for consistency.
# This removes the need for the separate ../config.json file.
USERNAME = os.getenv("HACKATHON_USERNAME", "Explorer")
SUIT_COLOR = os.getenv("HACKATHON_SUIT_COLOR", "blue")
APPEARANCE = os.getenv("HACKATHON_APPEARANCE", "A friendly person with short brown hair")
PROJECT_ID = os.getenv("GOOGLE_CLOUD_PROJECT")

if not PROJECT_ID:
    raise ValueError("GOOGLE_CLOUD_PROJECT environment variable must be set in your .env file")
